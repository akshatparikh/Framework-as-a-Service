          ...
          <div class="row">
            <div class="col-12 col-lg-6 col-xl-3">
                        <div class="widget widget-tile">
                          ...
                          <div class="data-info">
                            ...
                            <div class="value"><span class="indicator indicator-equal mdi mdi-chevron-right"></span><span class="number" data-toggle="counter" data-end="${countOfUser}">0</span>
                            </div>
                          </div>
                        </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3">
                        <div class="widget widget-tile">
                          ...
                          <div class="data-info">
                            ...
                            <div class="value"><span class="indicator indicator-positive mdi mdi-chevron-up"></span><span class="number" data-toggle="counter" data-end="${countOfProject}" data-suffix="%">0</span>
                            </div>
                          </div>
                        </div>
            </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3">
                        <div class="widget widget-tile">
                          ...
                          <div class="data-info">
                            <div class="desc">Total Feedbacks</div>
                            <div class="value"><span class="indicator indicator-negative mdi mdi-chevron-down"></span><span class="number" data-toggle="counter" data-end="${countOfFeedback}">0</span>
                            </div>
                          </div>
                        </div>
            </div>
              ...
              <div class="card card-table">
                ...
                <div class="card-body table-responsive">
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <tr>
                        <td class="user-avatar"> <img src="<%=request.getContextPath()%>/adminResources/images/avatar6.png" alt="Avatar">Penelope Thornton</td>
                        <td>Topbar dropdown style</td>
                        <td>Aug 16, 2018</td>
                        <td class="actions"><a class="icon" href="#"><i class="mdi mdi-github-alt"></i></a></td>
                      </tr>
                      <tr>
                        <td class="user-avatar"> <img src="<%=request.getContextPath()%>/adminResources/images/avatar4.png" alt="Avatar">Benji Harper</td>
                        <td>Left sidebar adjusments</td>
                        <td>Jul 15, 2018</td>
                        <td class="actions"><a class="icon" href="#"><i class="mdi mdi-github-alt"></i></a></td>
                      </tr>
                      <tr>
                        <td class="user-avatar"> <img src="<%=request.getContextPath()%>/adminResources/images/avatar5.png" alt="Avatar">Justine Myranda</td>
                        <td>Main structure markup</td>
                        <td>Jul 28, 2018</td>
                        <td class="actions"><a class="icon" href="#"><i class="mdi mdi-github-alt"></i></a></td>
                      </tr>
                      <tr>
                        <td class="user-avatar"> <img src="<%=request.getContextPath()%>/adminResources/images/avatar3.png" alt="Avatar">Sherwood Clifford</td>
