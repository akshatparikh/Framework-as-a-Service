...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="adminResources/css/dataTables.bootstrap4.css"/>
    <link rel="stylesheet" type="text/css" href="adminResources/css/responsive.bootstrap4.min.css"/>
  ...
  <body>
      ...
      <div class="be-content">
        ...
        <div class="main-content container-fluid">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Custom Layout
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
                  </div><span class="card-subtitle">This is a custom datable layout</span>
                </div>
                <div class="card-body">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Expandible responsive table
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Inmediate responsive Table
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Modal responsive table
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                      <div class="dropdown-divider"></div><a class="dropdown-item" href="#">Separated link</a>
                    </div>
    ...
    <script src="adminResources/js/jquery.dataTables.js" type="text/javascript"></script>
    <script src="adminResources/js/dataTables.bootstrap4.js" type="text/javascript"></script>
    <script src="adminResources/js/dataTables.buttons.min.js" type="text/javascript"></script>
    <script src="adminResources/js/buttons.flash.min.js" type="text/javascript"></script>
    <script src="adminResources/js/jszip.min.js" type="text/javascript"></script>
    <script src="adminResources/js/pdfmake.min.js" type="text/javascript"></script>
    <script src="adminResources/js/vfs_fonts.js" type="text/javascript"></script>
    <script src="adminResources/js/buttons.colVis.min.js" type="text/javascript"></script>
    <script src="adminResources/js/buttons.print.min.js" type="text/javascript"></script>
    <script src="adminResources/js/buttons.html5.min.js" type="text/javascript"></script>
    <script src="adminResources/js/buttons.bootstrap4.min.js" type="text/javascript"></script>
    <script src="adminResources/js/dataTables.responsive.min.js" type="text/javascript"></script>
    <script src="adminResources/js/responsive.bootstrap4.min.js" type="text/javascript"></script>
