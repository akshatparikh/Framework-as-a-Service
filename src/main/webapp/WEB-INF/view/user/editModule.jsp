  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Module</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                <div class="card-header card-header-divider">Add Module<span class="card-subtitle">Enter Module Details</span></div>
         <div class="card-body">
                
				<%@ taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
                <%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                 
                <f:form action="updateModule.html" modelAttribute="moduleList" method="get">
                <f:hidden path="loginVO.loginId"/>
                  
                <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right"><b>Projects</b></label>
           			         <div class="col-12 col-sm-8 col-lg-6">
					         <f:select path="projectVO.projectId">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right"><b>Module Name</b></label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input class="form-control" type="text" required="" placeholder="Module Name" path="moduleName" value="${i.moduleName}"/>
                     </div>
                    </div>
                    
                    <div class="form-group row">
                      <f:label class="col-12 col-sm-3 col-form-label text-sm-right" path="moduleDescription"><b>Module Description</b></f:label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input class="form-control" type="text" required="" data-parsley-minlength="6" placeholder="Describe the module" path="moduleDescription" value="${i.moduleDescription}"/>
                      </div>
                    </div>
                  
                  <f:input type="hidden" value="${i.moduleId}" path="moduleId"></f:input>
