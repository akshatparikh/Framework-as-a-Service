            ...
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                ...
                <%@taglib prefix="d" uri="http://java.sun.com/jstl/core_rt" %>
                  ...
                  <f:form action="/updateProject.html" modelAttribute="search_data" method="get">
                  <f:hidden path="loginVO.loginId"/>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input class="form-control" type="text" required="" placeholder="Project Name" path="projectName" value="${i.projectName}"/>
                      </div>
                    </div>
                    <div class="form-group row">
                      <f:label class="col-12 col-sm-3 col-form-label text-sm-right" path="projectDescription">Project Discription</f:label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input class="form-control" type="text" required="" data-parsley-minlength="10" placeholder="Describe your project" path="projectDescription" value="${i.projectDescription}"/>
                      </div>
                    </div>
                  
                  <f:input type="hidden" value="${i.projectId}" path="projectId"></f:input>
