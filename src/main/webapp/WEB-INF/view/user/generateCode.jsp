  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Generate Code</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Generate Code</a></li>
            </ol>
          </nav>
        </div>
                ...
                <div class="card-body">
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tr>
                        <td>${j.count}</td>
                        <td>${i.projectName}</td>
               			<td><a href="<%=request.getContextPath()%>/formList.html?projectId=${i.projectId}">Generate Code</a></td>
               			<td>
               				<c:if test="${flag eq download}">
               					<a href="<%=request.getContextPath()%>/sourcecode/${i.loginVO.username}/${i.projectName}.zip" download>Download</a>
               				</c:if>
               			</td>    
                      </tr>
                    </c:forEach>
