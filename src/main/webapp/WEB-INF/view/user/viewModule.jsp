  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">View Module</h2>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">List of Modules
                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                      ...
                      <tr class="odd gradeX">
                      	...
                      	<td>${j.count}</td>
                      	<td>${i.moduleName}</td>
                      	<td>${i.moduleDescription}</td>
                      	<td>${i.projectVO.projectName}</td>
                      	<td><a href="<%=request.getContextPath()%>/deleteModule.html?moduleId=${i.moduleId}">Delete</a></td>
                      	<td><a href="<%=request.getContextPath()%>/editModule.html?moduleId=${i.moduleId}">Edit</a></td>
