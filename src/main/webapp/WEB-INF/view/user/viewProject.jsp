                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tr>
                        ...
                        <td>${i.projectDescription}</td>
               			<td><a href="<%=request.getContextPath()%>/deleteProject.html?projectId=${i.projectId}">Delete</a></td>
               			<td><a href="<%=request.getContextPath()%>/editProject.html?projectId=${i.projectId}">Edit</a></td>    
                      </tr>
                    </c:forEach>
