  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Complaint</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                <div class="card-header card-header-divider">Add Complain<span class="card-subtitle">Enter complaint</span></div>
                <div class="card-body">
                  
                   <%@taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
	               <%@taglib prefix="d" uri="http://java.sun.com/jstl/core_rt" %>
                  
                  <f:form action="updateReply.html" modelAttribute="search_data" method="get">
					<f:hidden path="loginVO.loginId"/>
                                   
                    <div class="form-group row">
                      <f:label class="col-12 col-sm-3 col-form-label text-sm-right" path="complaintTitle">Complaint Subject</f:label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input readonly="true" class="form-control" type="text" required="" placeholder="Complaint Title" path="complaintTitle" value="${i.complaintTitle}"/>
                      </div>
                    </div>
                    <div class="form-group row">
                      <f:label class="col-12 col-sm-3 col-form-label text-sm-right" path="complaintDescription">Complaint Discription</f:label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input readonly="true" class="form-control" type="text" required="" data-parsley-minlength="10" placeholder="Describe your complain" path="complaintDescription" value="${i.complaintDescription}"/>
                      </div>
                    </div>
                     <div class="form-group row">
                      <f:label class="col-12 col-sm-3 col-form-label text-sm-right" path="complaintReply">Complaint Reply</f:label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input class="form-control" type="text" required="" placeholder="Complaint Reply" path="complaintReply"/>
                      </div>
                    </div>
                    
                  
                  <f:input type="hidden" value="${i.complaintId}" path="complaintId"></f:input>
                   <f:input type="hidden" value="${i.complaintDate}" path="complaintDate"></f:input>
