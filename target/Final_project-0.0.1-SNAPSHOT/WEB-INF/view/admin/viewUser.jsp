  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">View User</h2>
              ...
              <div class="card card-table">
                ...
                <div class="card-body">
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <c:forEach var="i" varStatus="j" items="${userList}">
                    	<tr>
                        	<td>${j.count}</td>
                        	<td>${i.username}</td>
                      
                  			 <td>
                   				 <c:forEach var="k" items="${projectList}" varStatus="l">
                     				<c:if test="${k.loginVO.loginId eq i.loginId}">                     	
                        				${k.projectName} &nbsp &nbsp &nbsp
                        			</c:if>
                    			</c:forEach>
                    		</td>   
                    
                    		<c:if test="${i.enabled eq '1'}">
                    			<td>
                    				<a href="blockUser.html?loginId=${i.loginId}">BLOCK</a>
								</td>
                    		</c:if>
                    		
                    
							<c:if test="${i.enabled eq '0'}">
								<td>
									<a href="unblockUser.html?loginId=${i.loginId}">UNBLOCK</a>
                        		</td>
                        	</c:if>
