...
<script type="text/javascript">	
		...
		function addTable()
  		{	
			var addFormToTable = document.getElementById("addFormToTable");
			...
			cell2.innerHTML="<input type='text' name='fieldList["+counter+"].file' value='"+file.value+"'>";
		...
		function addRadio()
  		{	
			...
			cell0.innerHTML="<input type='text' name='fieldName' value='"+fieldName.value+"'>";
			cell1.innerHTML="<input type='text' name'fieldType' value='"+fieldType.value+"'>";
			cell2.innerHTML="<input type='text' name'fieldValue' value='"+fieldValue.value+"'>";
              ...
              <div class="form-group row">
               ...
               <div class="form-group row">
					...
					<tr>
                     <td >
                      <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Choose a File</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" type="file"  required="required" id="file" name="file">
              		</div>
             		</div>  
					</td>
                     </tr>
