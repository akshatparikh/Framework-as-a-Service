...
function validateProjectName(){
	...
	htp.open("get","/user/validateProjectName.html?projectName="+a.value,true);
	htp.send();
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Manage Project</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                <div class="card-header card-header-divider">Add Project<span class="card-subtitle">Enter project details</span></div>
                <div class="card-body">
                
                
                <%@taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
                
                  <f:form action="/insertProject.html" modelAttribute="ProjectVO" method="post">
                    <div class="form-group row">
                      <f:label class="col-12 col-sm-3 col-form-label text-sm-right" path="projectName">Project Name</f:label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input class="form-control" type="text" required="required" placeholder="Project Name" path="projectName" id="projectName" onblur="validateProjectName()"/>
                      </div>
                     <div style="display: none;" id="errorMessage"><span style="color: red;">This project is already exists</span></div>
                    </div>
                    <div class="form-group row">
                      <f:label class="col-12 col-sm-3 col-form-label text-sm-right" path="projectDescription">Project Discription</f:label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input class="form-control" type="text" required="required" data-parsley-minlength="10" placeholder="Describe your project" path="projectDescription"/>
                      </div>
                    </div>
