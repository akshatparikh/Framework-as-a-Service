            ...
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary">
                ...
                <div class="card-body">
                  ...
                  <f:form action="updateComplaint.html" modelAttribute="search_data" method="get">
                  <f:hidden path="loginVO.loginId"/>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input class="form-control" type="text" required="" placeholder="Complaint Title" path="complaintTitle" value="${i.complaintTitle}"/>
                      </div>
                    </div>
                    <div class="form-group row">
                      <f:label class="col-12 col-sm-3 col-form-label text-sm-right" path="complaintDescription">Complaint Discription</f:label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <f:input class="form-control" type="text" required="" data-parsley-minlength="10" placeholder="Describe your complain" path="complaintDescription" value="${i.complaintDescription}"/>
                      </div>
                    </div>
