    ...
    <div class="be-wrapper be-fixed-sidebar">
      <jsp:include page="header1.jsp"></jsp:include>
        ...
        <div class="main-content container-fluid" style="background-color: white">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="widget widget-fullwidth be-loading" style="background-image: url(adminResources/images/cd.png); background-size: 2500px 1300px">
                
                <div class="widget-chart-container">
                  
                  <p style="font-size:25px "><center> <b style="font-size:150px ">WHY US?</b></center></p> <br><br>
                  
              <p style="font-size:25px ">  <b style="font-size:100px ">C</b>  ODERS...Tired of writing same code again and again? We all know that it is very BORING to make different files again and again to execute single program.
               ...
               <span style='font-size:25px;'>&#8680; <u>Productivity</u></span><br><br>
				...
				With code written manually instead you can have different developers use different styles and occasionally introduce errors even in the most repetitive code.
                  ...
                  <div id="main-chart" style="height: 175px;"></div>
                </div>
