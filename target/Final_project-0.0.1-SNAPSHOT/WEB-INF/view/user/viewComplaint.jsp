                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tr>
                        ...
                        <td>${i.complaintStatus}</td>
               			<td><a href="<%=request.getContextPath()%>/deleteComplaint.html?complaintId=${i.complaintId}">Delete</a></td>
               			<td><a href="<%=request.getContextPath()%>/editComplaint.html?complaintId=${i.complaintId}">Edit</a></td>    
                      </tr>
                    </c:forEach>
